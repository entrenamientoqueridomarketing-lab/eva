...
function cycleSummaryForPlan(plan, month) {
  // v25.3: el ciclo operativo mide el avance consolidado del plan.
...
function openModal(type) {
  ...
  if (type === 'actualizar-disponible-real') {
    const cuenta = findCuenta(accountNameDefault()) || (D.cuentas && D.cuentas[0]) || {};
...
async function doUpdateDisponibleReal() {
  ...
  const cuenta = findCuenta(nombre) || {};
