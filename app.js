// ============================================================
// EVA — app.js v25.4
// Fixes: nomenclatura clara de capital del plan + saldo conciliado como histórico.
//        Separa balance inicial, capital asignado, libre, ocupado, pendiente de liberar y flotante.
//        El ciclo muestra consolidado separado del estimado con flotante.
// ============================================================

const EVA_VERSION = 'v25.4';
...
function renderPlan(kind) {
  ...
  return `
    ...
    <div class="kpi-grid compact-plan">
      ...
      ${kpi('Capital libre para operar', money(capitalLibrePlan), 'Capital asignado menos posiciones abiertas del plan', capitalLibrePlan>=0?'teal':'red')}
