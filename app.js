...
function renderDashboard() {
  ...
  return `
    ...
    <div class="kpi-grid">
      ${kpi('Disponible real / buying power', money(d.disponibleReal), `${mxn(d.disponibleReal)} · capturado manualmente`, d.disponibleReal>=0?'teal':'red')}
  ...
  return `<div class="card">
    <div style="display:flex;justify-content:space-between;gap:12px;align-items:flex-start;flex-wrap:wrap">
      <div>
        ...
        <div style="font-size:13px;color:var(--muted)">Capital operativo combinado = Acciones + Opciones, calculado desde datos reales del sistema, no desde un buying power manual.</div>
      </div>
...
function renderLibertad() {
  ...
  return `
    ...
    <div class="card">
      ...
      <div class="alert-info" style="margin-top:10px">Estos valores salen de tus trades y planes. No dependen del campo manual de buying power. El buying power solo sirve para saber cuánto efectivo libre hay hoy en la cuenta.</div>
    </div>
...
async function saveLibertadConfig() {
  ...
  try {
    ...
    closeModal();
    await syncAll();
    showToast('Ruta de libertad guardada.', 'success');
  } catch(e) { showToast(e.message, 'error'); }
}
