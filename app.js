...
function getFreedomState() {
  ...
  const capitalOperativo = capitalConsolidado + capitalPendiente;
  ...
  return {
    ...fc,
    planAcc, planOpc,
    accConsolidado, opcConsolidado, accPendiente, opcPendiente,
    capitalConsolidado, capitalPendiente, capitalOperativo,
    stage, stageProgress,
...
function renderPage() {
  ...
  if (currentPage === 'libertad') setTimeout(() => drawLibertadCharts(), 80);
}
...
function renderDashboard() {
  ...
  return `
    ...
    <div class="sec-title">Ruta de libertad financiera</div>
  ...
  return `<div class="card">
    <div style="display:flex;justify-content:space-between;gap:12px;align-items:flex-start;flex-wrap:wrap">
      <div>
        ...
        <div style="font-size:13px;color:var(--muted)">Capital operativo = capital consolidado de acciones/opciones + capital pendiente de liberar.</div>
      </div>
      <button class="btn btn-blue" onclick="showPage('libertad')">Ver ruta completa</button>
    </div>
    <div class="kpi-grid" style="margin-top:12px">
      ${kpi('Capital operativo combinado', money(f.capitalOperativo), `Consolidado ${money(f.capitalConsolidado)} + pendiente ${money(f.capitalPendiente)}`, 'blue')}
